    ...
    <section class="container mx-auto py-8">
        ...
        <form action="{{ route('peliculas.store') }}" method="POST" class="max-w-md mx-auto">
            ...
            <div class="mb-6">
                ...
                <input type="number" name="presupuesto" id="presupuesto" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
