...
<header class="bg-red-600 text-white py-4">
    <div class="container mx-auto px-4">
        <h1 class="text-2xl font-bold">Projecte LaravelTinkering Pietro Scorza</h1>
    </div>
</header>
...
<footer class="bg-red-800 text-white py-4 mt-8">
    <div class="container mx-auto px-4 flex justify-between items-center">
        ...
        <a href="https://github.com" target="_blank" rel="noopener noreferrer" class="text-white hover:text-red-200">
